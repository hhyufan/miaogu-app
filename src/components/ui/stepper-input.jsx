...
const DecrementTrigger = React.forwardRef(function DecrementTrigger(props, ref) {
    return (
...
const IncrementTrigger = React.forwardRef(function IncrementTrigger(props, ref) {
    return (
